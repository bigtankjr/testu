...
class AddTestingLocationActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_testing_location)

        setSupportActionBar(toolbar_add_testing_location) // Use the toolbar to set the action bar.
        supportActionBar?.setDisplayHomeAsUpEnabled(true) // This is to use the home back button.
        // Setting the click event to the back button
        toolbar_add_testing_location.setNavigationOnClickListener {
            onBackPressed()
        }
        ...
        if (!Places.isInitialized()) {
            Places.initialize(
                this@AddTestingLocationActivity,
        ...
        if (mTestingLocationDetails != null) {
            supportActionBar?.title = "Edit Testing Location"

            et_title.setText(mTestingLocationDetails!!.title)
            et_description.setText(mTestingLocationDetails!!.description)
            et_date.setText(mTestingLocationDetails!!.date)
            et_location.setText(mTestingLocationDetails!!.location)
            mLatitude = mTestingLocationDetails!!.latitude
            mLongitude = mTestingLocationDetails!!.longitude

            saveImageToInternalStorage = Uri.parse(mTestingLocationDetails!!.image)
            ...
            R.id.btn_save -> {
                ...
                when {
                    ...
                    saveImageToInternalStorage == null -> {
                        ...
                        val testingLocationModel = TestingLocationModel(
                            if (mTestingLocationDetails == null) 0 else mTestingLocationDetails!!.id,
            ...
            if (requestCode == GALLERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@AddTestingLocationActivity, "Failed!", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
    ...
    /**
     * A function to save a copy of an image to internal storage for TestU App to use.
     */
    ...
    private val mLocationCallback = object : LocationCallback() {
        override fun onLocationResult(locationResult: LocationResult) {
            ...
            // START
            val addressTask =
                GetAddressFromLatLng(this@AddTestingLocationActivity, mLatitude, mLongitude)
    ...
    companion object {
        ...
        private const val IMAGE_DIRECTORY = "TestingLocationImages"
